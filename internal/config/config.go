...
type OpenAIConfig struct {
	...
	SummaryBaseURL  string `toml:"summary_base_url"`
...
func (c *Config) Normalize() error {
	...
	c.OpenAI.SummaryBaseURL = strings.TrimSpace(c.OpenAI.SummaryBaseURL)
...
func (c *Config) ApplyRuntimeEnv() {
	...
	c.OpenAI.SummaryBaseURL = c.envOrDefault("GITCRAWL_SUMMARY_BASE_URL", c.OpenAI.SummaryBaseURL)
